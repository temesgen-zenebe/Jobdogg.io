...
class CustomerContactInformationCreateView(CreateView):
    ...
    success_url = reverse_lazy('userContactInfo:success-Confirmation')
...
class SuccessConfirmationView(TemplateView):
    template_name = 'userContactInfo/SuccessConfirmation.html'